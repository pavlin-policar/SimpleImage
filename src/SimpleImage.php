 ...
 * Class SimpleImage
 *
 * Handles resizing of image and some other useful options that come in handy when creating slide
 * shows and various thumbnails, so resizing does not have to be done manually.
 *
...
class SimpleImage
{
    ...
    private function findImageData($imageName, array $options)
    {
        ...
        $data =
            $this->imageMap->get($imageName, $options['width'], $options['height'], $aspectRatio);
